...
如图\ref{fig:aly-demo-b,fig:aly-demo-5}所示，用户在框图和折线图等其他类型的图表上也可以查看到其他的规律和统计，通过每个图表对于的AI总结用户也可以较为简单地获知从图表中可以看出的规律和相应的营运建议。
...
ShopEyes移动应用程序的顾客（Guest）端用于基于消费者商品信息查询和购买指引。如图所示，用户
